...
const Errors = require("../api/errors/project-main-error.js");
...
const logger = LoggerFactory.get("ProjectMainAbl");

class ProjectMainAbl {
  constructor() {
...
module.exports = new ProjectMainAbl();
